...
module load python
python bar-input.py $SCRATCH/fill_estimation $SCRATCH/fill_estimation/haswell $SCRATCH/fill_estimation/haswell/performance-matrix.npy $SLURM_ARRAY_TASK_ID
